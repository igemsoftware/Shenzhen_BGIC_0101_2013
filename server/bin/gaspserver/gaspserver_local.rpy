import sys
import time
# change this to the directory containing the gaspserver directory on your machine
pathToGasp = "/Users/adammarblestone/desktop/gasp-ahm/cleaned-up-scripts/"
...
<div id="je_warningdiv">
    ...
    def render_POST(self, request):
       ...
       configFile = open(pathToGasp + "gaspserver/plate-based-assembly-from-ols-pool-config.json", "w")
       json.dump(config, configFile, indent = 5)
       configFile.close()
       out = open(pathToGasp + "gaspserver/input-seqs/inputfile.txt", 'wb')
