...
return declare( null, {
    ...
    show: function( args ) {
        ...
        var content = [
                dom.create( 'div', { className: 'intro', innerHTML: 'Add Genome data files and URLs, and JBrowse will automatically suggest tracks to display their contents.' } ),
